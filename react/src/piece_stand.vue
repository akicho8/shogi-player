<template>
<div class="flex-item piece_stand" :class="[`location_${location.key}`, $parent.env, {turn_active: $parent.mediator.current_location === location}]">
  <ul>
...
.shogi-player
  .piece_stand
    ...
    //   background: $sp_simple_board_color_bg
