[
  ...
  { key: "ev_foul_click_but_self_is_not_turn"                        , name: "手番が違うのに操作しようとした",                 desc: "", },
  { key: "ev_foul_my_turn_but_oside_click"                        , name: "自分が手番だが相手の駒を動かそうとした",         desc: "", },
  { key: "ev_foul_foul_accident"                             , name: "反則が発生したとき",                             desc: "sp_foul_validate&&sp_foul_cancelのときのみ", },
