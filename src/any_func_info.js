...
export default class AnyFuncInfo extends MemoryRecord {
  static get define() {
    return [
      ...
      { key: "----",               func: e => { }, },
      { key: "上にスライド",       func: e => { e.mediator.slide_xy(0, -1) }, },
      { key: "下にスライド",       func: e => { e.mediator.slide_xy(0, 1)  }, },
      { key: "左にスライド",       func: e => { e.mediator.slide_xy(-1, 0) }, },
      { key: "右にスライド",       func: e => { e.mediator.slide_xy(1, 0)  }, },
      { key: "----",               func: e => { }, },
