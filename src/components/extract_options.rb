...
# >> --sp_piece_count_gap_right: 86%      // 駒数の位置(横配置時) (in PieceObjectCount.vue)
# >> --sp_piece_count_gap_bottom: 100%    // 駒数の位置(縦配置時) (in PieceObjectCount.vue)
# >> --sp_piece_count_font_size: 0.75rem  // 駒数の文字サイズ (in PieceObjectCount.vue)
# >> --sp_piece_count_font_color: #000000 // 駒数の文字色 (in PieceObjectCount.vue)
