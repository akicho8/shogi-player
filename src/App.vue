        ...
        <div class="container has-text-centered">
          ...
          <div class="columns">
            <div class="column">
              ...
              <hr>
              <ShogiPlayer :kifu_body="kif_sample1" :turn_start="121" :controller_show="true" :slider_show="true" />
            </div>
                  ...
                  <div class="content">
                    <p>
                      <ul>
                        ...
                        <li>シフト以外のシステムキーだと50倍速(シフトキーも押していると150倍)</li>
