...
* production:
  * JSDelivr: https://cdn.jsdelivr.net/npm/shogi-player@0.0.373/dist/shogi-player-wc.min.js
  * UNPKG: https://unpkg.com/shogi-player@0.0.373/dist/shogi-player-wc.min.js
* development:
  * JSDelivr: https://cdn.jsdelivr.net/npm/shogi-player@0.0.373/dist/development/shogi-player-wc.min.js
  * UNPKG: https://unpkg.com/shogi-player@0.0.373/dist/development/shogi-player-wc.min.js

::: tip
本当は https://cdn.jsdelivr.net/npm/shogi-player@0.0.373 でいいはずだけど、画像パスがずれて駒が表示されない問題があるため js までの正確なパスでアクセスしないといけない
:::
...
`@x.x.x` でバージョンを固定できる
https://cdn.jsdelivr.net/npm/shogi-player@0.0.373/dist/shogi-player-wc.min.js
