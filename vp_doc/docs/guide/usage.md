...
::: tip
本当は https://cdn.jsdelivr.net/npm/shogi-player@0.0.378 でいいはずだけど、画像パスがずれて駒が表示されない問題があるため js までの正確なパスでアクセスしないといけない
:::
...
`@x.x.x` でバージョンを固定できる
https://cdn.jsdelivr.net/npm/shogi-player@0.0.378/dist/shogi-player-wc.min.js
