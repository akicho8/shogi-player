...
* JSDelivr: https://cdn.jsdelivr.net/npm/shogi-player@1.0.1
* UNPKG:    https://unpkg.com/shogi-player@1.0.1

### 正確なパスと development 版

* JSDelivr:
  * https://cdn.jsdelivr.net/npm/shogi-player@1.0.1/dist/wc/production/shogi-player-wc.min.js
  * https://cdn.jsdelivr.net/npm/shogi-player@1.0.1/dist/wc/development/shogi-player-wc.min.js
* UNPKG:
  * https://unpkg.com/shogi-player@1.0.1/dist/wc/production/shogi-player-wc.min.js
  * https://unpkg.com/shogi-player@1.0.1/dist/wc/development/shogi-player-wc.min.js
...
* https://unpkg.com/shogi-player@1.0.1
