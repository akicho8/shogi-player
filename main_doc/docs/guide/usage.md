...
* JSDelivr:
  * https://cdn.jsdelivr.net/npm/shogi-player@0.0.394/dist/wc/production/shogi-player-wc.min.js
  * https://cdn.jsdelivr.net/npm/shogi-player@0.0.394/dist/wc/development/shogi-player-wc.min.js
* UNPKG:
  * https://unpkg.com/shogi-player@0.0.394/dist/wc/production/shogi-player-wc.min.js
  * https://unpkg.com/shogi-player@0.0.394/dist/wc/development/shogi-player-wc.min.js

::: tip
本当は https://unpkg.com/shogi-player@0.0.394 でいいはずだけど、画像パスがずれて駒が表示されない問題があるため js までの正確なパスでアクセスしないといけない
:::
