...
<!-- ``` js -->
<!-- [ -->
<!--   { think_mark_pos_key: "7_6",     think_mark_user_name: "alice",  think_mark_color_index: 0, }, -->
<!--   { think_mark_pos_key: "white_P", think_mark_user_name: "bob",    think_mark_color_index: 1, }, -->
<!-- ] -->
<!-- ``` -->
...
<!-- 盤が反応するタイミング -->
<!--  -->
<!--   * どちらにも一長一短あるが対局で用いるなら fast であるべき -->
<!--   * WEB で盤面を複数してその盤面のせいでスクロールができず困る場合にのみ slow にする -->
<!--  -->
<!-- | 値   | 挙動                       | 同じ挙動の将棋アプリ   | メリット                       | デメリット                       | -->
<!-- |------|----------------------------|------------------------|--------------------------------|----------------------------------| -->
<!-- | slow | 押して離した瞬間に反応する | ぴよ将棋               | 盤面に触れてスクロールができる | タイミングのずれに違和感がでる   | -->
<!-- | fast | 触れた瞬間に反応する       | 将棋ウォーズ / lishogi | きびきび動く                   | 盤面に触れてスクロールができない | -->
