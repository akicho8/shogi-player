...
describe("Xcontainer", () => {
  ...
  it("後手から始まる", () => {
    ...
    // console.log(xcontainer.turn_offset_min)
    // console.log(xcontainer.turn_offset_max)
    // console.log(xcontainer.turn_offset)
