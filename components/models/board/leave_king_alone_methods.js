...
// そのとき board をわたさなければ ghost_move にするのはどうだろう？ → やっぱここでいい
...
// | Method                         | 状況     | 動作                 |
// |--------------------------------+----------+----------------------|
// | soldier_move_then_king_death_p | 指した後 | 自玉が取られるか？   |
// | soldier_drop_then_king_death_p | 打った後 | 自玉が取られるか？   |
// | soldier_move_then_checkmate_p  | 指した後 | 敵玉が詰んでいるか？ |
// | soldier_drop_then_checkmate_p  | 打った後 | 敵玉が詰んでいるか？ |
// |--------------------------------+----------+----------------------|
...
export class LeaveKingAloneMethods {
  ...
  // これらは一見、Board が関係ないように見えるが、奥の方で this.lookup を呼んでいるのでギリここでいい
