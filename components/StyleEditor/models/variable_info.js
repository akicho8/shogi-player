...
export class VariableInfo extends ApplicationMemoryRecord {
  static get define() {
    return [
      ...
      { key: "sp_board_horizontal_gap",                name: "盤の左右の隙間(左右配置時)",                                                group: "geneal",   context_type: "sp_css",    type: "Float",   sub_type: null,    default_value: 0.0,                      development_value: null, min: 0.0,    max: 1.0,  step: 0.01,  parent_key: null,            relative_model: null,                        },
      { key: "sp_board_vertical_gap",                  name: "盤の上下の隙間(上下配置時)",                                                group: "geneal",   context_type: "sp_css",    type: "Float",   sub_type: null,    default_value: 0.0,                      development_value: null, min: 0.0,    max: 1.0,  step: 0.01,  parent_key: null,            relative_model: null,                        },
      ...
      { key: "sp_piece_count_size",                    name: "駒数の大きさ",                                                              group: "geneal",   context_type: "sp_css",    type: "Float",   sub_type: null,    default_value: 0.2,                      development_value: null, min: null, max: null, step: null,    parent_key: null,            relative_model: null,                        },
      ...
      { key: "sp_piece_count_padding",                 name: "駒数のパディング",                                                          group: "geneal",   context_type: "sp_css",    type: "Float",   sub_type: null,    default_value: 0.08,                     development_value: null, min: null, max: null, step: null,    parent_key: null,            relative_model: null,                        },
      ...
      { key: "sp_request_snapshot_hash",               name: "操作モード時に千日手判定用の局面ハッシュを着手イベントに含める",            group: "geneal",   context_type: "sp_var",    type: "Bool",    sub_type: null,    default_value: false,                    development_value: null, min: null, max: null, step: null,    parent_key: null,            relative_model: "BinaryInfo",                },
      ...
      { key: "sp_lift_cancel_action",                  name: "盤上の持ち上げた駒のキャンセル方法",                                        group: "geneal",   context_type: "sp_var",    type: "String",  sub_type: null,    default_value: "reality",                development_value: null, min: null, max: null, step: null,    parent_key: null,            relative_model: "LiftCancelActionInfo",      },
