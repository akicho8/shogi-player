...
export class VariableInfo extends ApplicationMemoryRecord {
  static get define() {
    return [
      ...
      { key: "sp_player_name_size",                    name: "対局者の名前の大きさ",                                                      group: "geneal",   context_type: "sp_css",    type: "Float",   sub_type: null,    default_value: 0.18,                     development_value: null, min:    0, max:  0.5, step: 0.001,   parent_key: null,            relative_model: null,                        },
