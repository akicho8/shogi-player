...
export class VariableInfo extends ApplicationMemoryRecord {
  static get define() {
    return [
      ...
      { key: "origin_mark_user_name",            name: "移動元印の名前",             group: "geneal",   context_type: "se_var",    type: "String",  sub_type: null,    default_value: "(name)",                 development_value: null, min: null, max: null, step: null,    parent_key: null,            relative_model: null,                        },
      { key: "origin_mark_color_index",          name: "移動元印の色",               group: "geneal",   context_type: "se_var",    type: "Integer", sub_type: null,    default_value: 0,                        development_value: null, min: 0,    max: 9 - 1,  step: 1,       parent_key: null,            relative_model: null,                        }, // SP_GENERAL_MARK_PALETTE_COUNT
      { key: "sp_origin_mark_variant",           name: "移動元印の種類",             group: "geneal",   context_type: "sp_var",    type: "String",  sub_type: null,    default_value: "square_color",       development_value: null, min: null, max: null, step: null,    parent_key: null,            relative_model: "OriginMarkVariantInfo",               },
      ...
      { key: "think_mark_user_name",             name: "思考印の名前",               group: "geneal",   context_type: "se_var",    type: "String",  sub_type: null,    default_value: "(name)",                 development_value: null, min: null, max: null, step: null,    parent_key: null,            relative_model: null,                        },
      { key: "think_mark_color_index",           name: "思考印の色",                 group: "geneal",   context_type: "se_var",    type: "Integer", sub_type: null,    default_value: 0,                        development_value: null, min: 0,    max: 9 - 1,  step: 1,       parent_key: null,            relative_model: null,                        }, // SP_GENERAL_MARK_PALETTE_COUNT
      { key: "sp_think_mark_variant",            name: "思考印の種類",               group: "geneal",   context_type: "sp_var",    type: "String",  sub_type: null,    default_value: "circle_color",       development_value: null, min: null, max: null, step: null,    parent_key: null,            relative_model: "ThinkMarkVariantInfo",               },
