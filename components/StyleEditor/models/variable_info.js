...
export class VariableInfo extends ApplicationMemoryRecord {
  static get define() {
    return [
      ...
      { key: "sp_think_mark_variant",            name: "思考印の種類",               group: "geneal",   context_type: "sp_var",    type: "String",  sub_type: null,    default_value: "tmv_circle_color",       development_value: null, min: null, max: null, step: null,    parent_key: null,            relative_model: "ThinkMarkVariantInfo",               },
