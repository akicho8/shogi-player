...
export const mod_origin_mark = {
  ...
  mounted() {
    if (false) {
      this.origin_mark_list_json_text = `[
  ...
  methods: {
    ...
    origin_mark_preset_apply_handle(origin_mark_preset_info) {
      this.origin_mark_list_json_text = origin_mark_preset_info.body.trim()
    ...
    origin_mark_apply_handle() {
      try {
        this.sp_origin_mark_list = JSON5.parse(this.origin_mark_list_json_text)
      } catch (e) {
        console.error(e)
      }
    },
    ...
    origin_mark_item_attributes(general_mark_pos_key) {
      return {
        ...
        general_mark_group_name: this.origin_mark_group_name,
