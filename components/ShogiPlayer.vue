  ...
  watch: {
    ...
    mut_mode(new_val, old_val) {
      ...
      if (this.edit_p) {
        ...
        this.xcontainer.piece_box_adjust$()
      }
    },
    ...
    sp_human_side() {
      this.log("駒を持った状態で sp_human_side が変更になって指せなくなったとき駒を離す")
      this.hold_cancel()
    },
...
.ShogiPlayer
  ...
  // 駒台のセルの大きさ
  +defvar(sp_stand_cell_size, calc(1.0 / 10))
  ...
  // 駒箱のセルの大きさ
  +defvar(sp_piece_box_cell_size, calc(1.0 / 10))
